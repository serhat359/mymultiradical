...
{
	// sendmessage example: "M=91 235&o=j"
...
var cgiscript="http://kanji.sljfaq.org/minidic-1.cgi";
var iframe=false;
...
var href='minidic.cgi?r='+encodeURIComponent(search_string);var window_preference=get_window_preference();if(window_preference==1){window.open(href);}
else{location.href=href;}}
function change_input_box()
{var el=getbyid("input_box_input");var value=el.value;set_cookie(input_box_cookie+encodeURIComponent(value));}
...
var n_radicals=253;var mr_buttons_selected=0;var mr_button_states=new Array();var mr_chosens=new Array();
...
FourCorner.prototype.send=function()
{
	...
	for(x in this.clicked){if(this.clicked[x]>=0){r+=x+" "+this.clicked[x]+"  ";}}
	
	var self=this;
	r+="&o=j";
	sendget(r,function(reply){self.addResult(reply);});
}
...
if(this.selected>0){this.send();}else{this.reset();}}
